  ...
  const renderContent = () => {
    ...
    switch (view) {
      ...
      case 'results':
        ...
        // If quizAnswers is null, fall back to the quiz view
        return <Quiz onSubmit={handleQuizSubmit} onViewAll={handleViewAll} />;
      case 'allPhones':
        return <AllPhonesList phones={phonesDB} onBack={handleRestart} onPhoneSelect={handlePhoneSelect} />;
      default:
        return <Quiz onSubmit={handleQuizSubmit} onViewAll={handleViewAll} />;
    }
  };
    ...
    <div className="min-h-screen bg-slate-900 text-white font-sans flex flex-col items-center p-4 sm:p-6 md:p-8">
      ...
      {selectedPhone && (
        <PhoneReviewModal
          ...
          countryCode={location?.countryCode} // Pass countryCode directly from context
        />
      )}
